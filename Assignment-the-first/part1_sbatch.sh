...
#SBATCH --job-name=demulti_part1_R3       #optional: job name
#SBATCH --output=demulti_part1_R3%j.out       #optional: file to store stdout from job, %j adds the assigned jobID
#SBATCH --error=demulti_part1_R3%j.err        #optional: file to store stderr from job, %j adds the assigned jobID
